...
const cmLanguages = [
  ...
  LanguageDescription.of({ name: "CSS", extensions: ["css"], load() { return import("@codemirror/lang-css").then(m => m.css()); } }),
  LanguageDescription.of({ name: "Go", extensions: ["go"], load() { return import("@codemirror/lang-go").then(m => m.go()); } }),
  LanguageDescription.of({ name: "HTML", alias: ["htm"], extensions: ["html", "htm"], load() { return import("@codemirror/lang-html").then(m => m.html()); } }),
  LanguageDescription.of({ name: "Java", extensions: ["java"], load() { return import("@codemirror/lang-java").then(m => m.java()); } }),
  LanguageDescription.of({ name: "JavaScript", alias: ["ecmascript", "js", "node"], extensions: ["js", "mjs", "cjs"], load() { return import("@codemirror/lang-javascript").then(m => m.javascript()); } }),
  LanguageDescription.of({ name: "JSON", extensions: ["json", "map"], load() { return import("@codemirror/lang-json").then(m => m.json()); } }),
  LanguageDescription.of({ name: "JSX", extensions: ["jsx"], load() { return import("@codemirror/lang-javascript").then(m => m.javascript({ jsx: true })); } }),
  ...
  LanguageDescription.of({ name: "Markdown", alias: ["md"], extensions: ["md", "markdown"], load() { return import("@codemirror/lang-markdown").then(m => m.markdown()); } }),
  ...
  LanguageDescription.of({ name: "TypeScript", alias: ["ts", "typescript"], extensions: ["ts", "tsx"], load() { return import("@codemirror/lang-javascript").then(m => m.javascript({ jsx: true })); } }),
